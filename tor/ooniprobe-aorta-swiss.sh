...
#==============================================================================
#title           :aorta-tor-with-ooniprobe-install.sh
...
mv /etc/network/interfaces /etc/network/interfaces.old.$(date +%y%m%d%H%M%S)
...
iface eth0 inet static
  ...
  post-up route add -net 192.168.1.0/24 gw 192.168.179.1
...
iface eth1 inet dhcp
  post-up /root/masquerading.sh
#you have to copy the marclandolt.ch/script/masquerading.sh 


auto wlan0
iface wlan0 inet dhcp
 wireless-essid FREIFUNKrombachtaeli
 wirelsee-mode managed
...
#allow-hotplug wlan1
#iface wlan1 inet manua    wpa-conf /etc/wpa_supplicant/wpa_supplicant.conf
#    wpa-conf /etc/wpa_supplicant/wpa_supplicant.conf
